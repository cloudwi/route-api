class AddDiaryPromptData < ActiveRecord::Migration[8.1]
  def up
    prompts = [
      # 감정 (Emotion) - 20개
      ...
      { content: "학창 시절 가장 재미있었던 일은 무엇인가요?", category: "추억" },
      { content: "가족과 함께한 추억 중 가장 따뜻했던 순간은?", category: "추억" },
      { content: "첫사랑의 추억이 있나요?", category: "추억" },
      ...
      { content: "가족에게 감사한 점이 있나요?", category: "감사" },
      { content: "친구에게 감사한 점이 있나요?", category: "감사" },
