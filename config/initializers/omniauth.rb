...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  client_id = Rails.application.credentials.dig(Rails.env.to_sym, :kakao, :client_id)
  client_secret = Rails.application.credentials.dig(Rails.env.to_sym, :kakao, :client_secret)
